  ...
  <body>
    ...
    <nav role="navigation" class="navbar navbar-custom">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand" style="color: #fff;">Quizz</a>
          </div>
    ...
    <div class="container-fluid">
	   ...
	   <table class="table table-striped">
				...
				<?php foreach($presentateur as $p){ ?>
			    <tr>
					<td><?php echo $p['id']; ?></td>
					<td><?php echo $p['password']; ?></td>
					<td><?php echo $p['username']; ?></td>
					<td>
			            <a href="<?php echo site_url('presentateur/edit/'.$p['id']); ?>">Edit</a> | 
			            <a href="<?php echo site_url('presentateur/remove/'.$p['id']); ?>">Delete</a>
			        </td>
			    </tr>
				<?php } ?>
			</table>
			<?php echo anchor('presentateur/add', "<button class='btn btn-primary'>ajouter</button>"); ?>
			</div>
